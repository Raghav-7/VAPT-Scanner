...
app.get('/api/scan/:scanId/export', (req, res) => {
  ...
  const report = {
    ...
    tool: 'Mendix VAPT Scanner v1.0.0',
...
app.get('/api/scan/:scanId/export-excel', async (req, res) => {
  ...
  try {
    ...
    workbook.creator = 'Mendix VAPT Scanner';
    ...
    subCell.value = 'Generated by Mendix VAPT Scanner v1.0.0';
...
server.listen(PORT, () => {
  console.log(`\n╔══════════════════════════════════════════════════╗`);
  console.log(`║     Mendix VAPT Scanner v1.0.0                   ║`);
